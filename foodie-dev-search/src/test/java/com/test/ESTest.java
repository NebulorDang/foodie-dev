...
public class ESTest {
    ...
    public void createIndexStu() {
        ...
        stu.setName("yezi");
        stu.setAge(18);
        stu.setSign("carpe diem");
        stu.setMoney(122.3f);
        stu.setDescription("i want study");
    ...
    public void updateStuDoc() {
        ...
        sourceMap.put("sign", "I don't want study");
        sourceMap.put("money", 123.7f);
    ...
    public void searchStuDoc() {
        ...
        SearchQuery query = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.matchQuery("name", "yezi"))
    ...
    public void highlightStuDoc() {
        ...
        SearchQuery query = new NativeSearchQueryBuilder()
                .withQuery(QueryBuilders.matchQuery("description", "want"))
